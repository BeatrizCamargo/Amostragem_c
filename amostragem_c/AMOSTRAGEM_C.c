...
void menu() {
    ...
    do {
        ...
        printf("\n\n");
        printf("----------------------------------------------CALCULE AMOSTRAGENS!!!--------------------------------------------\n\n\n");
        printf("                                                         \n");
        printf("                                                                        \n");
        printf("                    ESCOLHA UMA OPÇÃO                          \n");
        printf("                |                                                        \n");
        printf("                                                                         \n");
        printf("               I     (1) Amostra Sistemática                    \n");
        printf("                                                                         \n");
        printf("                     (2) Amostragem Casual ou Aleatária Simples \n");
        printf("                                                                         \n");
...
void sistematica() {
    ...
    printf("\n\nA amostra sorteada para dar inicio a seleção é: %i", primeiro);
...
void proporcial_estratificada() {
    ...
    for(c=0; c<v; c++) {
        ...
        printf("\nInsira o valor da %dé amostra a ser retirada: ", c+1);
